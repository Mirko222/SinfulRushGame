...
package com.custom.badlogic;

import android.media.MediaPlayer;
import com.badlogic.gdx.Gdx;
import com.pizzaroof.sinfulrush.audio.TimescaleMusic;

import java.io.IOException;

public class AndroidMusic implements TimescaleMusic, MediaPlayer.OnCompletionListener {
	public final AndroidAudio audio;
	...
	public void setSpeed(float speed) {
		if(player == null) return;
		System.out.println("MOD SPEED: "+speed);
		if(Gdx.app.getVersion() >= 23)
			this.player.setPlaybackParams(player.getPlaybackParams().setSpeed(speed));
	}
}
